...
Config.RandomStr = function(length)
    if length > 0 then
        return Config.RandomStr(length - 1) ..
                   StringCharset[math.random(1, #StringCharset)]
    else
        return ''
    end
end
...
Config.RandomInt = function(length)
    if length > 0 then
        return Config.RandomInt(length - 1) ..
                   NumberCharset[math.random(1, #NumberCharset)]
    else
        return ''
    end
end
...
Config.CraftingItems = {
    ...
    [2] = {
        ...
        amount = 50,
        info = {},
        costs = {["metalscrap"] = 30, ["plastic"] = 42},
        type = "item",
        slot = 2,
        threshold = 0,
        points = 2
...
Config.AttachmentCrafting = {
    ...
    ["items"] = {
        ...
        [7] = {
            ...
            amount = 50,
            info = {},
            costs = {["metalscrap"] = 270, ["steel"] = 435, ["rubber"] = 155},
            type = "item",
            slot = 5,
            threshold = 150,
            points = 5
        ...
        [8] = {
            ...
            amount = 50,
            info = {},
            costs = {["metalscrap"] = 300, ["steel"] = 469, ["rubber"] = 170},
            type = "item",
            slot = 6,
            threshold = 200,
            points = 6
